...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?echo base_url('bootstrap/css/bootstrap.css')?>">
    <link href=<?echo base_url("assets/vendor/fonts/circular-std/style.css");?> rel="stylesheet">
    <link rel="stylesheet" href=<?echo base_url("assets/libs/css/style.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/fonts/fontawesome/css/fontawesome-all.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/charts/chartist-bundle/chartist.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/charts/morris-bundle/morris.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/charts/c3charts/c3.css");?>>
    <link rel="stylesheet" href=<?echo base_url("assets/vendor/fonts/flag-icon-css/flag-icon.min.css");?>>
                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Total de diarias</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header"> Total diarias</h5>
                                <div class="card-body">
                                    <div id="morris_totalrevenue"></div>
                                </div>
                                <div class="card-footer">
                                    <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">R$26,000
...
<!-- Optional JavaScript -->
<!-- jquery 3.3.1 -->
<script src=<?echo base_url("assets/vendor/jquery/jquery-3.3.1.min.js");?>></script>
<!-- bootstap bundle js -->
<script src=<?echo base_url("assets/vendor/bootstrap/js/bootstrap.bundle.js");?>></script>
<!-- slimscroll js -->
<script src=<?echo base_url("assets/vendor/slimscroll/jquery.slimscroll.js");?>></script>
<!-- main js -->
<script src=<?echo base_url("assets/libs/js/main-js.js");?>></script>
<!-- chart chartist js -->
<script src=<?echo base_url("assets/vendor/charts/chartist-bundle/chartist.min.js");?>></script>
<!-- sparkline js -->
<script src=<?echo base_url("assets/vendor/charts/sparkline/jquery.sparkline.js");?>></script>
<!-- morris js -->
<script src=<?echo base_url("assets/vendor/charts/morris-bundle/raphael.min.js");?>></script>
<script src=<?echo base_url("assets/vendor/charts/morris-bundle/morris.js");?>></script>
<!-- chart c3 js -->
<script src=<?echo base_url("assets/vendor/charts/c3charts/c3.min.js");?>></script>
<script src=<?echo base_url("assets/vendor/charts/c3charts/d3-5.4.0.min.js");?>></script>
<script src=<?echo base_url("assets/vendor/charts/c3charts/C3chartjs.js");?>></script>
<script src=<?echo base_url("assets/libs/js/dashboard-ecommerce.js");?>></script>
</body>
